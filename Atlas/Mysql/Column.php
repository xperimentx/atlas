...
class Column
{
    ...
    function Render_sql()
    {
        ...
        if ($this->is_autoincrement) $out .=' AUTO_INCREMENT';
        ...
        else
        {
            ...
            $out .= ' DEFAULT \''.addslashes($this->default).'\'';
        }


        if ($this->collation) ' COMMENT \''.addslashes($this->comment  ).'\'';
        if ($this->collation) ' COLLATE \''.addslashes($this->collation).'\'';
    }
    ...
    public static function Int($field_name, $default_value=null, $length='11')
    {
        return  static::Basic('INT', $field_name, $default_value=null, $length);
    }

    public static function Tinyint($field_name, $default_value=null, $length='4')
    {
        return  static::Basic('INT', $field_name, $default_value, $length);
    }


    public static function Decimal($field_name, $default_value=null, $length='10,2')
    {
        return  static::Basic('DECIMAL', $field_name, $default_value, $length);
    }


    public static function Varchar($field_name, $default_value=null, $length=250)
    {
        return  static::Basic('VARCHAR', $field_name, $default_value, $length);
    }

    public static function Text($field_name, $default_value=null )
    {
        return  static::Basic('TEXT', $field_name, $default_value, null);
    }
